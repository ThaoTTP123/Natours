...
exports.getMyTours = catchAsync(async (req, res, next) => {
  ...
  if (!bookings) console.log('aaaaaaaa');
...
exports.updateTour = factoryUpdateOne(Tour);
exports.deleteTour = factoryDeleteOne(Tour);
...
exports.getToursWithin = catchAsync(async (req, res, next) => {
  ...
  if (!lat || !lng) {
    return next(new AppError('Please provide latitude and longtitude!', 400));
  }
